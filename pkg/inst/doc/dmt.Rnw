...
The tests/ directory of the package contains a comprehensive set of
...
for particular algorithms (drCCA, fit.dependency.model, etc.), see
also separate citation information in the documentation. 
